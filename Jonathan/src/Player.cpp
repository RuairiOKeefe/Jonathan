...
void Player::Update(float dt, std::vector<Projectile>& projectileList, float maxX, float maxY, SFMLSoundProvider &soundProvider)
{
	...
	if (sf::Keyboard::isKeyPressed(sf::Keyboard::Space) || (sf::Joystick::isConnected(0) && (sf::Joystick::getAxisPosition(0, sf::Joystick::Axis::Z) < -20) || (sf::Joystick::isButtonPressed(0, 2))))
	{
